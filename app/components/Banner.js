...
const Banner = () => {
    return (
    <main>
        <div className='w-full overflow-hidden sm:w-[80%] mb-40  relative mx-auto '>
            ...
            <div className='mx-auto overflow-hidden '>
                 ...
                 <div className=' sm:p-0 p-10 text-center sm:py-60  relative z-10'>
                    ...
                    <p className='text-white w-full text-center  xl:w-[50%] sm:px-20 mb-5 mx-auto sm:mb-10 text-xl'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
                        <div className='inline-flex w-full  box-border sm:w-[50%] items-center justify-center mx-auto'>
                        <input type="text" defaultChecked={true} placeholder='Search your services'  className='bg-white w-full sm:w-[70%]  text-left rounded px-5 py-3 sm:px-20 sm:py-5 mr-4' />
