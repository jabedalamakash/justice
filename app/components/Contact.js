    ...
    return (
        ...
        <main className='w-full sm:w-[80%] mx-auto px-5 sm:px-0 mb-40'>
             <div>
                ...
                <p className='text-center text-xl w-full sm:w-[50%] mx-auto'>There are many variations of passages of Lorem Ipsum available, but the majority havesuffered alteration in some form, by injected humour.</p>
        ...
        <div className='w-full sm:w-1/2 grid grid-cols-1 mb-10 sm:mb-0 mx-auto sm:grid-cols-2 sm:mr-10'>
                ...
                <div className=' text-center border-t-2 sm:border-t-0  border-b-2 sm:border-r-2 bg-[#f3f3f3] p-5 sm:p-20'>
                    <Image
                ...
                <div className=' text-center  border-b-2 bg-[#f3f3f3] p-5 sm:p-20'>
                    <Image
                    src={"/images/call.png"}
                    height={100}
                    width={100}
                ...
                <div className=' text-center border-b-2 sm:border-b-0  sm:border-r-2 bg-[#f3f3f3] p-5 sm:p-20'>
                    <Image
                ...
                <div className=' text-center border-b-2 sm:border-b-0 bg-[#f3f3f3] p-5 sm:p-20'>
                    <Image
                    src={"/images/time.png"}
                    height={100}
                    width={100}
                    ...
                    <div className='w-full sm:w-1/2'>
                        <form >
                            ...
                            <button  className='w-full rounded bg-[#B68C5A] text-lg text-white text-center font-bold px-10 py-10'   type="submit">Send Message</button>
                            </form>
